  ...
  stages {
    stage('Git Checkout') {
      steps {
        ...
        git branch: 'master', url: 'https://github.com/KhagendraTiwari/health-care.git'
                        }
            }
    ...
    stage('Generate Test Report') {
     ...
     stage('Create Docker Image') {
      steps {
        ...
        sh 'docker build -t khagendratiwari/healthcare:1.0 .'
                          }
            }
    ...
    stage('Docker Push-Image') {
      steps {
        ...
        sh 'docker push khagendratiwari/healthcare:1.0'
            }
      }
    stage('AWS-Login') {
      steps {
